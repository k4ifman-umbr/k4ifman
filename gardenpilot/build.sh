...
javac -encoding UTF-8 -source 8 -target 8 -d build/tests src/app/gardenpilot/Engine.java tests/EngineTest.java
...
javac -encoding UTF-8 -source 8 -target 8 -bootclasspath "$GP_JAR" -d build/classes @build/sources.txt
